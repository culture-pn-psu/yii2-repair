...
/**
 * ApproveSearch represents the model behind the search form about `backend\modules\repair\models\Repair`.
 */
class ApproveSearch extends Repair
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andWhere(['status'=>[2,3,4]]);
//        $query->andWhere(['not', ['staff_status' => null]]);
//        $query->andWhere(['not', ['boss_status' => null]]);
        //$query->andWhere(['not', ['admin_status' => null]]);
