...
/**
 * ConsiderSearch represents the model behind the search form about `backend\modules\repair\models\Repair`.
 */
class ConsiderSearch extends Repair {
