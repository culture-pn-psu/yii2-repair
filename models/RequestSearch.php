...
/**
 * RequestSearch represents the model behind the search form about `backend\modules\repair\models\Repair`.
 */
class RequestSearch extends Repair
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['id','material_id', 'problem', 'solving', 'staff_comment', 'boss_comment', 'admin_comment'], 'safe'],
        ];
    }
